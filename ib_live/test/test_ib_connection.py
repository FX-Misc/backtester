...
# from production.IB.ib_connection import IBConnection
# from production.IB.ib_execution_handler import create_order
...
#         contract = create_futures_contract('GC', exp_month=5, exp_year=2016)
